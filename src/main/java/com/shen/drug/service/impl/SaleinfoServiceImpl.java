...
import com.shen.drug.entity.Saleinfo;
import com.shen.drug.mapper.DruginfoMapper;
import com.shen.drug.mapper.SaleinfoMapper;
import com.shen.drug.service.ISaleinfoService;
...
public class SaleinfoServiceImpl extends ServiceImpl<SaleinfoMapper, Saleinfo> implements ISaleinfoService {
    ...
    public int addSaleinfo(Saleinfo saleinfo) {
        ...
        queryWrapper.like("name", saleinfo.getDname());
